...
######################################################################
def hawkid():
    return(["Angelina Evans", "angevans"])
...
def printResults():
    ...
    mode = input("Please specify the calculation method: min, max, or avg: ")
    count = int(input("Please specify the number of values you want to submit: "))
    valuesList = []

    for i in range(0,count):
        valuesList.append(float(input("Please enter a number: ")))

        
    print("Angelina Evans")
    print("angevans")
    print(mode)
    print(count)
...
def printMoreResults():
    ...
    # finding minimum
        valuesList.sort()
        final_ans = valuesList[0]
    elif mode =="max":
    # finding maximum
        valuesList.sort()
        final_ans = valuesList[-1]
    elif mode =="avg":
        elem_sum = 0
        for element in valuesList:
            elem_sum+=element
        final_ans = elem_sum/len(valuesList)
    # finding average
